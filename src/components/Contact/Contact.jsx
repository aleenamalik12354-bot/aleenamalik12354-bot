...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-4xl sm:text-5xl font-bold text-[var(--text-primary)] mb-4 tracking-tight">
          {t('contact.title')}
        </h2>
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-6">
          ...
          <div className="group bg-[var(--card-bg)] backdrop-blur-xl p-8 rounded-2xl border border-[var(--border-color)] hover:border-purple-500/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(147,51,234,0.15)] flex flex-col justify-center h-full">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h4 className="text-[var(--text-secondary)] text-sm font-semibold uppercase tracking-wider mb-1">{t('contact.email')}</h4>
                <a href="mailto:aleenamalik12354@gmail.com" className="text-[var(--text-primary)] font-medium text-lg hover:text-[#d946ef] transition-colors">
          ...
          <div className="group bg-[var(--card-bg)] backdrop-blur-xl p-8 rounded-2xl border border-[var(--border-color)] hover:border-purple-500/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(147,51,234,0.15)] flex flex-col justify-center h-full">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h4 className="text-[var(--text-secondary)] text-sm font-semibold uppercase tracking-wider mb-1">Location</h4>
                <p className="text-[var(--text-primary)] font-medium text-lg">Wah Cantt, Pakistan</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <form ref={form} onSubmit={sendEmail} className="flex flex-col space-y-5">
            <div>
              <input
                ...
                required
                className="w-full bg-[var(--primary-bg)] text-[var(--text-primary)] p-4 rounded-xl border border-[var(--border-color)] focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all placeholder-[var(--text-secondary)] font-medium"
              />
            </div>
            <div>
              <input
            ...
            <div>
              <textarea
                ...
                rows="4"
                required
                className="w-full bg-[var(--primary-bg)] text-[var(--text-primary)] p-4 rounded-xl border border-[var(--border-color)] focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all resize-none placeholder-[var(--text-secondary)] font-medium"
              />
            </div>
