        ...
        <div className="fixed inset-0 z-[-1] overflow-hidden bg-primary">
            ...
            <motion.div style={{ y: y1, rotate }} className="absolute top-0 left-0">
                <motion.div
                    ...
                    className="w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-[120px] opacity-50 will-change-transform"
                />
            </motion.div>
            ...
            <motion.div style={{ y: y2 }} className="absolute top-1/2 right-0">
                <motion.div
                    ...
                    className="w-[600px] h-[600px] bg-pink-500/20 rounded-full blur-[120px] opacity-50 will-change-transform"
                />
            </motion.div>
            ...
            <motion.div style={{ y: y1 }} className="absolute bottom-0 left-1/4">
                <motion.div
                    ...
                    className="w-[400px] h-[400px] bg-indigo-500/20 rounded-full blur-[100px] opacity-50 will-change-transform"
                />
            </motion.div>
